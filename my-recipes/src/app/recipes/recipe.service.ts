...
export class RecipeService {
    ...
    private recipes: Recipe[] = [
        ...
        [
            new Ingredient('Pepe',50),
            new Ingredient('Pecorino',150),
            new Ingredient('Guanciale',80),
            new Ingredient('Pasta',200)
        ]),
        new Recipe('Amatriciana', 
        ...
        [
            new Ingredient('Passata di pomodoro',200),
            new Ingredient('Guanciale',80),
            new Ingredient('Pasta',200),
            new Ingredient('Pecorino',80)
        ]),
        new Recipe('Lasagne', 
        ...
        [
            new Ingredient('Ragu',100),
            new Ingredient('Romagnole',150),
            new Ingredient('Besciamella',80),
            new Ingredient('Parmigiano',50)
        ])
    ];
